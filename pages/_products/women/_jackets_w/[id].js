...
const {_options_select_clothes}=__select_options()
return (
<>
<_Page_id data={data} _select_options={_options_select_clothes} _type="Jacket"/>
</>
...
try{
const _data=await axios.get(`http://localhost:3000/api/_products/_women/_jackets/${context.params.id}`)
return {
props:{
data:_data.data,
}

...
return (
<>
<_Page_id data={data} _select_options={_options_select_shoes_m}  _type="Shoes"/>
</>
...
try{
const _data=await axios.get(`http://localhost:3000/api/_products/_men/_shoes/${context.params.id}`)
return {
props:{
data:_data.data,
}
